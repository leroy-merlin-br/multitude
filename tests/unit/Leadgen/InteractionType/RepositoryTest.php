...
class RepositoryTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testShouldUpdateExisting()
    {
        ...
        $this->resourceRepo->shouldReceive('updateExisting')
            ->once()
            ->with($interactionType, ['foo' => 'bar'])
            ->andReturn($result);

        // Assert
        $this->assertEquals($result, $repo->updateExisting($interactionType, ['foo' => 'bar']));
    }
    ...
    public function testShouldDeleteExisting()
    {
        ...
        // Assert
        $this->assertEquals($result, $repo->deleteExisting($interactionType));
    }
